...
public class FlightController {
	...
	public ResponseEntity<String> deleteflight(@Valid @RequestParam Integer flightNumber) throws FlightException
	{
		try
		{
	...
	public ResponseEntity<String> updateflight(@Valid @RequestBody Flight flight,@RequestParam Integer flightNumber,BindingResult br ) throws FlightException
	{
		String err = "";
		if (br.hasErrors()) {
			List<FieldError> errors = br.getFieldErrors();
